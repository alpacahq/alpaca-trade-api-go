...
func (sc *stocksClient) SubscribeToTrades(handler func(Trade), symbols ...string) error {
	...
	return sc.client.handleSubChange(true, newSubChangeRequest(), subscriptions{trades: symbols})
}
...
func (sc *stocksClient) SubscribeToQuotes(handler func(Quote), symbols ...string) error {
	...
	sc.handler.mu.Unlock()
	return sc.client.handleSubChange(true, newSubChangeRequest(), subscriptions{quotes: symbols})
}
...
func (sc *stocksClient) SubscribeToBars(handler func(Bar), symbols ...string) error {
	...
	sc.handler.mu.Unlock()
	return sc.client.handleSubChange(true, newSubChangeRequest(), subscriptions{bars: symbols})
}
...
func (sc *stocksClient) SubscribeToDailyBars(handler func(Bar), symbols ...string) error {
	...
	sc.handler.mu.Unlock()
	return sc.client.handleSubChange(true, newSubChangeRequest(), subscriptions{dailyBars: symbols})
}
...
func (sc *stocksClient) UnsubscribeFromQuotes(symbols ...string) error {
	return sc.handleSubChange(false, newSubChangeRequest(), subscriptions{quotes: symbols})
}

func (sc *stocksClient) UnsubscribeFromBars(symbols ...string) error {
	return sc.handleSubChange(false, newSubChangeRequest(), subscriptions{bars: symbols})
}

func (sc *stocksClient) UnsubscribeFromDailyBars(symbols ...string) error {
	return sc.handleSubChange(false, newSubChangeRequest(), subscriptions{dailyBars: symbols})
}
...
func (cc *cryptoClient) SubscribeToTrades(handler func(CryptoTrade), symbols ...string) error {
	...
	return cc.client.handleSubChange(true, newSubChangeRequest(), subscriptions{trades: symbols})
}
...
func (cc *cryptoClient) SubscribeToQuotes(handler func(CryptoQuote), symbols ...string) error {
	...
	cc.handler.mu.Unlock()
	return cc.client.handleSubChange(true, newSubChangeRequest(), subscriptions{quotes: symbols})
}
...
func (cc *cryptoClient) SubscribeToBars(handler func(CryptoBar), symbols ...string) error {
	...
	cc.handler.mu.Unlock()
	return cc.client.handleSubChange(true, newSubChangeRequest(), subscriptions{bars: symbols})
}
...
func (cc *cryptoClient) SubscribeToDailyBars(handler func(CryptoBar), symbols ...string) error {
	...
	cc.handler.mu.Unlock()
	return cc.client.handleSubChange(true, newSubChangeRequest(), subscriptions{dailyBars: symbols})
}

func (cc *cryptoClient) UnsubscribeFromTrades(symbols ...string) error {
	return cc.handleSubChange(false, newSubChangeRequest(), subscriptions{trades: symbols})
}

func (cc *cryptoClient) UnsubscribeFromQuotes(symbols ...string) error {
	return cc.handleSubChange(false, newSubChangeRequest(), subscriptions{quotes: symbols})
}

func (cc *cryptoClient) UnsubscribeFromBars(symbols ...string) error {
	return cc.handleSubChange(false, newSubChangeRequest(), subscriptions{bars: symbols})
}

func (cc *cryptoClient) UnsubscribeFromDailyBars(symbols ...string) error {
	return cc.handleSubChange(false, newSubChangeRequest(), subscriptions{dailyBars: symbols})
}
